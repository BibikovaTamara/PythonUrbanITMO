...
KGIOP_FILE_URL = "https://raw.githubusercontent.com/BibikovaTamara/PythonUrbanITMO/main/geojson%20слои/kgiop_objects.geojson"

STREETS_FILE_URL = "https://raw.githubusercontent.com/BibikovaTamara/PythonUrbanITMO/main/geojson%20слои/streets.geojson"  # ссылка на слой с улицами
...
gdf = gpd.dissolve(by="Название")

"""### Сохранение слоя с улицами (Load)"""

gdf = gpd.dissolve(by="Название")# TODO переименовать столбцы в русские названия, кроме столбца geometry
